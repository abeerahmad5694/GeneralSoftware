...
export const headerQuoConBy = document.getElementById("header_quo_con_by");
export const headerQuoConNo = document.getElementById("header_quo_con_no");
export const btnDeleteBill = document.getElementById("btn-delete-bill");
